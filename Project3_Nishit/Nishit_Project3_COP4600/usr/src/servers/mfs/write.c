 ...
 */
  ...
  if(sequential)
  	zone_size = (rip->i_sp->s_block_size - sizeof(zone_t)) << scale;//----
  ...
  if(sequential)
  	next = pos + rip->i_sp->s_block_size - sizeof(zone_t) - 1;
  //-----------------------------------------------------------------
...
/*===========================================================================*
			zero_block_seq
=============================================================================*/
void zero_block_seq(bp)
register struct buf *bp;
{
	printf("\n Zero_block_seq Called ");
	zone_t next_zone = ((zone_t*)bp->data)[0];
	zero_block(bp);
	((zone_t*)bp->data)[0] = next_zone;
}
